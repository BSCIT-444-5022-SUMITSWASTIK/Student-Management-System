...
<%@ page import="com.sms.model.ProfileAttendance" %>

<%
    List<ProfileAttendance> list =
        (List<ProfileAttendance>) request.getAttribute("attendanceList");
%>
...
.status-na{ color:#999; font-weight:bold; }
...
<div class="wrapper">
    ...
    <div class="sidebar">
        ...
        <a href="ProfileAttendance" class="active"><i class="fa fa-calendar-check"></i> Attendance</a>
